...
```bash
curl -sSL [https://raw.githubusercontent.com/quilix11/git-reviewer/main/install.sh](https://raw.githubusercontent.com/quilix11/git-reviewer/main/install.sh) | bash
